...
<title>{:lang("admin/lang/index")}－{:lang('appName')}</title>
{/block}
<!-- -->
{block name="main"}
...
<form action="{:DcUrl('admin/lang/index')}" method="post" data-toggle="form">
...
<div id="toolbar d-flex justify-content-between d-md-block" class="toolbar">
  <div class="btn-group btn-group-sm">
    ...
    <div class="dropdown-menu">
      ...
      <button class="dropdown-item px-3" type="submit" data-action="{:DcUrl('admin/lang/delete')}" data-toggle="submit">
        <i class="fa fa-fw fa-trash"></i> {:lang('delete')}
      </button>
    </div>
  </div>
  <a class="btn btn-sm btn-danger" href="{:DcUrl('admin/lang/create',$query)}" data-toggle="create" data-modal-xl="0">
...
{:DcBuildTable([
    'data-name'               => 'admin/lang/index',
    'data-escape'             => true,
    'data-toggle'             => 'bootstrap-table',
    'data-url'                => DcUrl('admin/lang/index', $query),
    'data-url-sort'           => '',
    'data-url-preview'        => '',
    'data-url-edit'           => DcUrl('admin/lang/edit', ['id'=>'']),
    'data-url-delete'         => DcUrl('admin/lang/delete', ['id'=>'']),

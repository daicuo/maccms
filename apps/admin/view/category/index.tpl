...
<title>{:lang("admin/category/index")}－{:lang('appName')}</title>
{/block}
<!-- -->
{block name="main"}
...
<form action="{:DcUrl('admin/category/index')}" method="post" data-toggle="form">
...
<div class="toolbar d-flex justify-content-between d-md-block" id="toolbar">
  <div class="btn-group btn-group-sm">
    ...
    <div class="dropdown-menu">
      <button class="dropdown-item px-3" type="submit" data-action="{:DcUrl('admin/category/status',['value'=>'normal'])}" data-toggle="submit">
        <i class="fa fa-fw fa-eye"></i> {:lang('normal')}
      </button>
      <button class="dropdown-item px-3" type="submit" data-action="{:DcUrl('admin/category/status',['value'=>'hidden'])}" data-toggle="submit">
        <i class="fa fa-fw fa-eye-slash"></i> {:lang('hidden')}
      </button>
      <button class="dropdown-item px-3" type="submit" data-action="{:DcUrl('admin/category/delete')}" data-toggle="submit">
        <i class="fa fa-fw fa-trash"></i> {:lang('delete')}
      </button>
    </div>
  </div>
  <a class="btn btn-sm btn-danger" href="{:DcUrl('admin/category/create', $query)}" data-toggle="create" data-modal-xl="1">
...
{:DcBuildTable([
    'data-name'               => 'admin/category/index',
    'data-escape'             => false,
    'data-toggle'             => 'bootstrap-table',
    'data-url'                => DcUrl('admin/category/index', $query),
    'data-url-sort'           => '',
    'data-url-preview'        => DcUrl('admin/category/preview', ['id'=>'']),

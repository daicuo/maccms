...
<title>{$wd|DcHtml}的最新好看电影与电视剧-{:config('common.site_name')}</title>
{/block}
<!-- -->
...
<div class="row mx-1">
  <div class="col-12 px-1">
    <a class="btn btn-block btn-secondary" data-pageClick="true" data-pageScroll="true" data-url="{:DcUrl('maccms/filter/area',['wd'=>DcHtml($wd),
    'pageNumber'=>''])}" data-page="{$current_page}" data-target="#row" data-target-lazyload="#row img[data-original]" data-target-language="#row">更多结果 <i class="fa fa-lg fa-angle-down"></i></a>
  </div>
</div>
<!-- -->
</div>

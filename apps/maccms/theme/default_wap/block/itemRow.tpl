<div class="col-4 mb-3 px-1">
  ...
  <h6 class="text-truncate text-center pt-2 my-0"><a class="text-dark" href="{:playUrl( $maccms['play_last'], ['term_id'=>DcEmpty($term_id,$term['term_id']), 'term_slug'=>DcEmpty($term_slug,$term['term_slug'])]) }">{$maccms.vod_title}</a></h6>
</div>
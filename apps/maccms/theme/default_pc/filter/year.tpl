...
<title>{$wd|DcHtml}年好看的电影与电视剧第{$current_page|default='1'}页-{:config('common.site_name')}</title>
{/block}
<!-- -->
...
<div class="row d-md-none mb-2">
  <div class="col-12 px-2 px-md-3">
    <a class="btn btn-block btn-outline-secondary" data-pageClick="true" data-pageScroll="false" data-url="{:DcUrl('maccms/filter/year',['id'=>DcHtml($id)])}&pageNumber=" data-page="{$current_page}" data-target="#row" data-target-lazyload="#row img[data-original]" data-target-language="#row">更多结果 <i class="fa fa-lg fa-angle-down"></i></a>
  </div>
</div>
<!-- -->
</div> <!-- /container -->

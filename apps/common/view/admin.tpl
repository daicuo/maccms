      ...
      <div class="sidebar scrollbar pt-2">
        <ul class="nav flex-column" id="menu-parent">
          ...
          <li class="nav-item mb-2 pl-md-2">
            ...
            <ul class="list-unstyled collapse pl-2 {in name="controll" value="op,cache,video,upload"}show{/in}" id="menu-option" data-parent="#menu-parent">
              {volist name=":config('admin_menu.config')" id="menu"}
              <li class="list-item mb-2">
                <i class="{$menu.ico|DcHtml|default='fa fa-fw fa-angle-double-right'}"></i>
          ...
          <li class="nav-item mb-2 pl-md-2">
            ...
            <ul class="list-unstyled collapse pl-2 {:DcDefault(input('module'),$menu['menu_module'],'show')}" id="menu-{$menu.menu_module}" data-parent="#menu-parent">
              {volist name="menu.menu_items" id="subnav"}
              <li class="list-item mb-2">
                <i class="fa fa-fw {$subnav.ico|DcHtml|default='fa fa-angle-double-right'}"></i>
          ...
          <li class="nav-item mb-2 pl-md-2">
            ...
            <ul class="list-unstyled collapse pl-2 {in name="controll" value="apply,store"}show{/in}" id="menu-apply" data-parent="#menu-parent">
